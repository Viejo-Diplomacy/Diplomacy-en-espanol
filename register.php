...

{
	...
	case 'firstValidationForm':
		...
		<h2>No multicuentas</h2>

		<p>

		  S&oacute;lo puedes disponer de <em>una cuenta</em>, segundas cuentas no est&aacute;n permitidas bajo <em>ninguna circusancia</em>, y ser&aacute;n baneadas. Esto tambi&eacute;n puede dar lugar a tu primera cuenta tambi&eacute;n ser&aacute; baneada.&nbsp; si no recuerdas tu contrase&ntilde;a, recuperala clickeando <a class="light" href="logon.php?forgotPassword=1">Aqu&iacute;</a>. Si no lo consigues, contacta con los mods.
		...
		<p>
		  ...
		  No puedes hacer alianzas <em>por razones fuera del juego</em>, porque sois amigos, familiares o a cambio de un favor en otro juego. Esto se conoce como Metagaming y est&aacute; en contra de las reglas, ya que da una ventaja injusta a los involucrados. Si no se puedes apu&ntilde;alar a alguien porque quieres seguir siendo amigos, eso es bastante justo, pero no se puedes participar en una partida con ellos.
	...
	case 'validationForm':
		...
		require_once(l_r('locales/Spanish/validationForm.php'));
	...
	case 'userForm':
		...
		require_once(l_r('locales/Spanish/userRegister.php'));

		require_once(l_r('locales/Spanish/user.php'));

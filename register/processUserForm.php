...

{
	...
	print '</div>';
// Create Forum account mod : modified March 24th 2013 By Osman Kalache : osminosm@gmail.com
	print '</div>
	...
	<script type="text/javascript">
				jQuery.ajax({
					...
					data: {username: "'.$SQLVars['username'].'", email: "'.$SQLVars['email'].'", password: "'.$_REQUEST['userForm']['password'].'" guid : "'.User::findUsername($SQLVars['username']).'"}
					}).done(function(data) {jQuery(\'#fofoadd\').html(data);});
			</script>';

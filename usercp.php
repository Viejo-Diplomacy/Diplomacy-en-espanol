...

{
	...
	$tabs['General']=l_t("Ajustes generales");

	$tabs['Features']=l_t("Funciones especiales");

	$tabs['CountrySwitch']=l_t("Intercambia tu país con otro jugador temporalmente");
...

{
	...
	case 'Features':
		...
		require_once(l_r('locales/Spanish/accessability.php'));

		break;

	case 'CountrySwitch':

		require_once(l_r('locales/Spanish/countryswitch.php'));

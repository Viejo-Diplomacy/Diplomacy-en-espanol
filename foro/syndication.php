...
$query = $db->simple_select("posts", "subject, username, dateline, message, edittime, tid, fid, pid", "visible='1' ".$forumlist, array('order_by' => 'dateline', 'order_dir' => 'desc', 'limit' => $post_limit));

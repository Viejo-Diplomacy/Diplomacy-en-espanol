...
$l['req_check'] = 'Comprobación de requerimientos';
$l['db_config'] = 'Configuración de la base de datos';
...
$l['req_step_reqtable'] = '<div class="border_wrapper">
		...
		<thead>
			<tr>
				<th colspan="2" class="first last">Requerimientos</th>
			</tr>
		</thead>
		<tbody>
		<tr class="first">
...
$l['req_step_reqcomplete'] = '<p><strong>Enhorabuena, cumples todos los requerimientos para instalar MyBB.</strong></p>
...
$l['config_step_table'] = '<p>Ahora es el momento de configurar los ajustes básicos de tus foros como el nombre, URL, detalles de tu sitio web, dominio y ruta de las "cookie". Estos ajustes se podrán editar fácilmente en el futuro desde el panel de administración de MyBB.</p>
		<div class="border_wrapper">
			...
			<table class="general" cellspacing="0">
				...
				<tr>
					<th colspan="2" class="first last">Detalles de contacto (Se muestra en el pie)</th>
				</tr>
				<tr class="last">

...
if ($_COOKIE["password"] != $config['password_tools'])
{
	...
	{	
		echo '<center><font color="red"><b>Wrong Password !</b></font></center>';
	}
...
<div align="center"><b>
	<a href="?do=home">Home</a> | <a href="?do=showsmilies">All smilies</a> | <a href="?do=formadd">Add smilie</a> | <a href="?do=banmanage">Banned Users</a> | <a href="?do=notice">Notice</a> | <a href="?do=badword">Censor Words</a></b>
</div>
<div align="center">
	<b><a href="?do=editsmfile">Quick edit Smilie file</a></b> | <a href="?do=logout">Logout</a>
	<br /><br /><br />
</div>
<?php
...
if ($_REQUEST['do'] == 'formadd')
{
	...
	echo '<div>Path of smilie folder</div>';
	...
	echo "Add each smilie (Code | Image Link)";
...
if ($_REQUEST['do'] == 'banmanage')
{
	...
	echo "<div>User ID | Comment (username, reason....v.v)</div>";
...
{
	echo '<table width="100%" cellpadding="6" cellspacing="1" border="0" class="tborder"><tr><td class="alt1">';
	echo '<div>Edit notice</div><form name="cfc_notice" action="?do=savenotice" method="post">';

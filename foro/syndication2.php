 ...
 *
 * $Id: syndication.php 5380 2011-02-21 12:04:43Z Tomm $
 */
...
if(!empty($onlyusfids))
{
    ...
    $query = $db->simple_select("posts", "subject, dateline, message, edittime, tid, fid, pid", "visible='1' {$permsql} {$forumlist}", array('order_by' => 'dateline', 'order_dir' => 'desc', 'limit' => $post_limit));    

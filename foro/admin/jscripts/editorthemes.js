...
ThemeSelector.prototype = {
    ...
    initialize: function(url, save_url, selector, stylesheet, file, selector_form, theme)
    {
		if(url && save_url && selector && stylesheet && file && selector_form && theme)
        {
            this.url = url;
    ...
    updateSelector: function(e)
    {
        ...
        postData = "file="+encodeURIComponent(this.file)+"&theme="+encodeURIComponent(this.theme)+"&selector="+encodeURIComponent(this.selector.value)+"&my_post_key="+encodeURIComponent(my_post_key);
	...
	save: function(e, isajax)
    {
		...
		postData = "css_bits="+encodeURIComponent(js_array_to_php_array(css_bits))+"&selector="+encodeURIComponent(this.selector_prev_option)+"&file="+encodeURIComponent(this.file)+"&theme="+encodeURIComponent(this.theme)+"&my_post_key="+encodeURIComponent(my_post_key)+"&serialized=1";
